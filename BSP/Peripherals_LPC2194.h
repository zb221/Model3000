...
#define  Relay2_Pin_SET  {   IO0DIR|=(1<<23);IO0SET|=(1<<23);}
#define  Relay2_Pin_CLR  {   IO0DIR|=(1<<23);IO0CLR|=(1<<23);}

#define  Relay3_Pin_SET  {   IO0DIR|=(1<<24);IO0SET|=(1<<24);}
#define  Relay3_Pin_CLR  {   IO0DIR|=(1<<24);IO0CLR|=(1<<24);}

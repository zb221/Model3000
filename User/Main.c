...
extern unsigned char test_uart1;
extern unsigned char rcv_buf1[10];
extern unsigned char rcv_new1;
extern unsigned char rcv_cnt1;
extern unsigned char recept_value_buffer;
/*Output Parameters*/
...
//				IO1SET = EN_485_DE;	
//				Delay_us(10);
//				Uart1_SentByte(rcv_buf1[i]);	
//				IO1CLR = EN_485_DE;
//			}		
//		UARTprintf("testuart1\n");			
//		memset(rcv_buf1,0,rcv_cnt1);
//		rcv_cnt1=0;	
//		}
	}
}

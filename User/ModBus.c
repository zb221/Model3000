...
unsigned char rcv_buf1[10];
unsigned char rcv_cnt1;
unsigned char rcv_new1;
...
{		
	...
	VICVectAddr5=(unsigned long)IRQ_UART1;//Ñ¡ÔñÖÐ¶ÏÈë¿ÚµØÖ·µÄ³ÌÐ
	//VICIntEnClr|=1<<7; 
...
//¶ÁFlash
  case 101:
	{
  Spi_Flash_Data_read();//read flash data
	break;		
	}		
//************************************************	
  case 121:
...
//								Delay_us(1);
//								Uart1_SentByte(user_parameter.spi_flash_buffer[n]);
